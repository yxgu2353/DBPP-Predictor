...
def train_main(model_list, fp_list, train_name, test_name):
    ...
    train_metrics_file = open('Druglike_train_metrics.txt', 'w')
    cv_metrics_file = open('Druglike_cv_metrics.txt', 'w')
    tv_metrics_file = open('Druglike_tv_metrics.txt', 'w')
    parameter_file = open("Druglike_parameter.txt", "w")
    ...
    for method_name, fp_name, train_target, test_target in model_names:
        ...
        pickle.dump(saved_model, open('Druglike_' + method_name + '_' + fp_name + '.model', 'wb'))
...
if __name__ == '__main__':
    model_list = ['knn', 'rf', 'GBM']
    # model_list = ['svm']
    # model_list = ['MLP', 'rf']
    fp_list = ['RDKFingerprint', 'Morgan', 'MACCS', 'AtomPairs', 'TopoTorsion']
    # fp_list = ['Morgan', 'MACCS', 'GraphFP', 'EStateFP']
    # fp_list = ['Morgan', 'MACCS', 'Descriptor1']
    # fp_list = ['Descriptor']
